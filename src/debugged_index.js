...
function normalised(min, max, value) {
...
function get_average_coord(element, use_x) {
    let res = 0;
    for (const node of element.nodes) {
...
const texts = '';
(0, fs_1.writeFile)(mesh_file.replace('.json', '.svg'), `<svg xmlns="http://www.w3.org/2000/svg">${polygons}${texts}</svg>`, err => { });
